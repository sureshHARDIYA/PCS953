 ...
 * </p>
 * <ul>
 *   <li>{@link org.henshin.moviedb.impl.PersonImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.henshin.moviedb.impl.PersonImpl#getMovies <em>Movies</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PersonImpl extends MinimalEObjectImpl.Container implements Person {
	...
	protected EClass eStaticClass() {
		return MoviedbPackage.Literals.PERSON;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MoviedbPackage.PERSON__NAME, oldName, name));
	}
	...
	public EList<Movie> getMovies() {
		if (movies == null) {
			movies = new EObjectWithInverseResolvingEList.ManyInverse<Movie>(Movie.class, this,
					MoviedbPackage.PERSON__MOVIES, MoviedbPackage.MOVIE__PERSONS);
		}
		return movies;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case MoviedbPackage.PERSON__MOVIES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case MoviedbPackage.PERSON__NAME:
			return getName();
		case MoviedbPackage.PERSON__MOVIES:
			return getMovies();
		}
